...
//    public function recoverUserPassword($data = array()) {
//
//        $status = false;
//
//        try {
//
//            $sql = "UPDATE db_users SET us_pass = :password WHERE us_id = :recid ";
//
//            $stmt = $this->db->prepare($sql);
//
...
//            }
//        } catch (PDOException $e) {
//            error_log('recoverUserPassword EXCEPTION: ' . $e->getMessage());
//        }
//
//        return $status;
//    }
//    public function getUserImage($data = array()) {
//
//        $img = false;
//
//        try {
//
//            $sql = "SELECT us_image AS image FROM db_users WHERE us_id = :recid ";
//
//            $stmt = $this->db->prepare($sql);
//            $stmt->bindParam(':recid', $data['recid']);
//
...
//
//            $img = "data:image/png;base64,{$row['image']}";
//        } catch (PDOException $e) {
//            error_log('getUserImage EXCEPTION: ' . $e->getMessage());
//        }
//
//        return $img;
//    }
//    public function updateUseImage($data = array()) {
//
//        $status = false;
//
//        try {
//
//            $sql = "UPDATE db_users SET us_image = :a WHERE us_id = :i ";
//
//            $stmt = $this->db->prepare($sql);
//
//            $stmt->bindParam(':a', $data['image']);
//            $stmt->bindParam(':i', $data['recid']);
//
//            if ($stmt->execute()) {
//                $status = true;
//            }
//        } catch (PDOException $e) {
//            error_log('updateUseImage EXCEPTION: ' . $e->getMessage());
//        }
//
//        return $status;
//    }
...
//        try {
//
//            $sql = "UPDATE db_users SET us_pass = :pass WHERE us_id = :recid";
//
//            $stmt = $this->db->prepare($sql);
//
//            $stmt->bindParam(':pass', $data['base64']);
//            $stmt->bindParam(':recid', $data['recid']);
//
//            if ($stmt->execute()) {
//                $status = true;
//            }
//        } catch (PDOException $e) {
//            error_log('updatePassword EXCEPTION: ' . $e->getMessage());
//        }
//
//        return $status;
//    }
